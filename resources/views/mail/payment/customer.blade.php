                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding:30px">
                            ...
                            <p>Thank you for your order on our platform.Your payment for {{$trip->title}} with {{$agency->company_name}} was successful.</p>
                            <p>Following your successful payment,please find your invoice attached(in PDF format) to this email.</p>
